  ...
  <div class="container">
    ...
    <div class="row mb-3">
      <div class="col-lg-3 col-md-12 mb-5">
        <div class="row">
          <div class="col">
            <a href="<?= base_url('admin/users/tambahuser') ?>" class="btn btn-sm btn-primary mr-2 mb-2 w-100"><i class="fas fa-plus mr-1"></i> Tambah Pengguna</a>
          </div>
        </div>
        <div class="row">
          <div class="col">
            <a href="<?= base_url('admin/users/tambahteknisi') ?>" class="btn btn-sm btn-danger mr-2 mb-2 w-100"><i class="fas fa-plus mr-1"></i> Tambah Teknisi</a>
          </div>
        </div>
        <div class="row">
          <div class="col">
            <a href="<?= base_url('admin/users/tambahmanager') ?>" class="btn btn-sm btn-success mr-2 w-100"><i class="fas fa-plus mr-1"></i> Tambah Manager IT</a>
          </div>
        </div>
      </div>
